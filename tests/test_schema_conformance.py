...
CLASS_TO_SCHEMA = {
    ...
    HeartRateVariabilityPersonalRangeRollupValue: "HeartRateVariabilityPersonalRangeRollupValue",
    ...
    CaloriesInHeartRateZoneValue: "CaloriesInHeartRateZoneValue",
    CaloriesInHeartRateZoneRollupValue: "CaloriesInHeartRateZoneRollupValue",
}
